...
import com.app.mathpix_sample.evaluator.CalculateHandler;
    ...
    private void uploadImage(Bitmap bitmap) {
        ...
        UploadImageTask task = new UploadImageTask(new UploadImageTask.ResultListener() {
            ...
            public void onError(String message) {
                ...
                ResultActivity.goResultActivity(getActivity(),message);
            }

            @Override
            public void onSuccess(ArrayList<String> latex) {
                String result;
                try {
                    CalculateHandler calculateHandler = new CalculateHandler();

                    result = calculateHandler.getCalculateResult(getActivity(),latex);
                    Log.d(TAG + "CalculateHandler result",result);
                } catch (Exception e) {
                    result = e.getMessage();
                }

                ResultActivity.goResultActivity(getActivity(),result);
